...
import classes from "./ThreeImageLoopC.module.css"
...
function ThreeImageLoopC() {
  return (
    <div className={classes.ThreeImageLoopC}>
         <div className={classes.InvestHalf} style={{
            background: "#1D33540D"
                ...
                <div className={classes.LeftText}>
                    ...
                    <h2>Access Centralized <span style={{color: "#2286FE"}}> Dashboard.</span>
          </h2>
                    <br />
                    <p>
                    View all your real estate investments in one place with our intuitive dashboard.                    </p>                  
                  <br />
                    <br />
...
export default ThreeImageLoopC
